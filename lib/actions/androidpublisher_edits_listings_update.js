 ...
 *
 *
 * Operation: 'androidpublisher.edits.listings.update'
 * Endpoint Path: '/{packageName}/edits/{editId}/listings/{language}'
 * Method: 'put'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{packageName}/edits/{editId}/listings/{language}',
        method: 'put',
