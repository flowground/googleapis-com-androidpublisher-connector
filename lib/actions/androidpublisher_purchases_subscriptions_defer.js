 ...
 *
 *
 * Operation: 'androidpublisher.purchases.subscriptions.defer'
 * Endpoint Path: '/{packageName}/purchases/subscriptions/{subscriptionId}/tokens/{token}:defer'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{packageName}/purchases/subscriptions/{subscriptionId}/tokens/{token}:defer',
        method: 'post',
